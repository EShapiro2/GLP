#!/bin/bash
# GLP Type Checker Test Suite - FAST VERSION
...
NEGATIVE_FILES=(
    ...
    "$MODED_DIR/invalid/universal/any_constant_at_output.glp"
...
echo "Running ${#POSITIVE_FILES[@]} positive + ${#NEGATIVE_FILES[@]} negative tests..."
echo ""

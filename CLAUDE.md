...
**Loading a project**: enter the directory path at the prompt (e.g. `/Users/udi/Grassroots/GLP/programs/cssn_modules_v2/`).  This invokes the project linker, which resolves all `M # goal(...)` cross-module calls at compile time.
